...
def import_data():
    ...
    try:
        ...
        print(mfccs.shape)
        np.savez(os.path.join('../system/datas/', 'mfccs_dataset'),mfccs,labels,max_fs)
...
def trainer():
    ...
    elif os.path.exists('../system/datas/mfccs_dataset.npz'):
    ...
    # モデルの保存
    try:
        if os.path.exists('../system/models/mfcc_model'):
            model.save('../system/models/mfcc_model_added')
        else:
            model.save('../system/models/mfcc_model')
    except Exception as e:
